...
set "SCRIPT_NAME=auto_ruckus_unleashed_downloader.ps1"
set "LOCAL_FILE=%~dp0auto_ruckus_unleashed_downloader.ps1"
set "BACKUP_FILE=%~dp0auto_ruckus_unleashed_downloader.ps1.bak"

set "TEMP_DIR=%TEMP%\RuckusUnleashedUpdate"
set "TEMP_FILE=%TEMP_DIR%\auto_ruckus_unleashed_downloader.ps1"
...
echo.
echo ============================================================
echo [Ruckus Unleashed Firmware Downloader 실행]
echo ============================================================
echo.
